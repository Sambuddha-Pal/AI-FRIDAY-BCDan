...
#
# Retrieval is done with scikit-learn's TF-IDF + cosine similarity instead
# of a HuggingFace sentence-transformers embedding model. This is fully
# local/offline: no model download, no huggingface.co call, no SSL/cert
# bypass needed. It's a classic "bag of words" style similarity rather than
# a deep semantic embedding, but for a fixed, keyword-rich internal
# knowledge base like this it works very well and is instant to build.
...
# ========================================
# Bulk Upload / Analytics / History / Settings
# ========================================
# ⚠️ Your original file continues past this point (Bulk Upload page onward),
# but it was cut off in what you pasted, so it isn't reproduced here.
# Nothing below this line needed to change for this fix — paste your
# existing "elif page == 'Bulk Upload':" section onward back in below,
# unmodified. It doesn't reference sentence_transformers/faiss/huggingface
# so it will work as-is.
